...
button_add=Button(root,text="+",padx=40,pady=20,command=button_add,bg="black",fg="white")
button_equal=Button(root,text="=",padx=87,pady=20,command=button_equal,bg="black",fg="white")
button_clear=Button(root,text="CLEAR",padx=73,pady=20,command=button_clear,bg="black",fg="white")
button_sub=Button(root,text="-",padx=40,pady=20,command=button_sub,bg="black",fg="white")
button_mul=Button(root,text="*",padx=41,pady=20,command=button_mul,bg="black",fg="white")
button_div=Button(root,text="/",padx=42,pady=20,command=button_div,bg="black",fg="white")
